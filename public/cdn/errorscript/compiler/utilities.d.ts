...
/** @internal */
export declare function forEachYieldExpression<T>(body: Block, visitor: (expr: YieldExpression) => T): T | undefined;
/**
...
/** @internal */
export declare function getModuleSpecifierOfBareOrAccessedRequire(node: VariableDeclarationInitializedTo<RequireOrImportCall | AccessExpression>): StringLiteralLike | undefined;
/** @internal */
 ...
 */
export declare function usesWildcardTypes(options: CompilerOptions): options is CompilerOptions & {
    types: string[];
};
/** @internal */
...
/** @internal */
export declare const getAlwaysStrict: (compilerOptions: CompilerOptions) => boolean;
/** @internal */
...
/** @internal */
export type StrictOptionName = "noImplicitAny" | "noImplicitThis" | "strictNullChecks" | "strictFunctionTypes" | "strictBindCallApply" | "strictPropertyInitialization" | "strictBuiltinIteratorReturn" | "useUnknownInCatchVariables";
/** @internal */
...
/** @internal */
export declare function canHaveStatements(node: Node): node is Block | ModuleBlock | SourceFile | CaseClause | DefaultClause;
/** @internal */
export declare function isPotentiallyExecutableNode(node: Node): boolean;
export {};
